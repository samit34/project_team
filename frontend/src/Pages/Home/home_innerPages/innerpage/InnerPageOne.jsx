      ...
      <div className="py-2 pb-5 mx-auto max-w-6xl 2xl:max-w-full">
          ...
          <div className="absolute inset-1 sm:inset-10 flex items-center justify-start bg-opacity-40">
            <div className='block text-left'>
              ...
              <p className="text-xs sm:text-sm my-2 text-white ml-4 capitalize text-wrap">
                ...
                with professional & Experiene service provider</p>
              <button type="submit" className=' mt-3 ml-3 rounded-full px-2 py-1 sm:px-3 sm:py-2 text-white flex items-end sm:items-end sm:justify-center  text-xs sm:text-sm bg-blue-300'>Explore more
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 bg-gray-50 rounded-lg shadow-md my-4">
          ...
          <div className="text-left 2xl:text-center pb-2 ">
           <h2 className="text-lg sm:text-xl md:text-2xl font-bold uppercase text-grey-400 mb-3 ">about</h2>
            ...
            <div className="max-w-6xl mx-auto  ">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className=" p-6 rounded-lg shadow-md bg-white">
                  <h2 className="text-2xl bg-grey-200 font-bold mb-5">For {selectedSubcategory?.name} </h2>
                  <h4 className="text-lg font-semibold text-gray-700 capitalize mb-3"><strong className='text-2xl text-red-800 font-bold'>Knock knock!</strong>  Services at your door step</h4>
                  <p className="text-base text-gray-500">Highly skilled service provider for {selectedSubcategory?.name} professionals are always at your service. Just contact us as you want 
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore id voluptatibus excepturi?
