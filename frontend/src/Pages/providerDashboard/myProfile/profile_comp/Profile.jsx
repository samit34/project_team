                        ...
                        <div className="relative lg:row-span-2 lg:row-start-1">
                            ...
                            <div className="relative flex h-full flex-col overflow-hidden rounded-lg lg:rounded-lg">
                                ...
                                <div className="px-8 pt-2 pb-3 sm:px-10 sm:pt-2 sm:pb-0 text-center">
                                    ...
                                    <p className="text-gray-500">Electrician</p>
                                ...
                                <div className="px-8 pt-2 pb-3 sm:px-10 sm:pt-2 sm:pb-0 text-left">
                                    <div className="text-left w-full mt-6">
                                        ...
                                        <p className=" text-sm text-[#9CA3AF]">
                                            ...
                                            since the 1500s, when an unknown electrician took a galley of type.
                                        </p>
                                        <p className="mt-2 text-[#A1A1AA]"><strong >Full Name:</strong> Tosha K. Minner</p>
                                        <p className='text-[#A1A1AA]'><strong >Mobile:</strong> (123) 123 1234</p>
                                        <p className='text-[#A1A1AA]'><strong >Email:</strong> user@email.domain</p>
                                        <p className='text-[#A1A1AA]'><strong >Location:</strong> USA</p>
                                    </div>
